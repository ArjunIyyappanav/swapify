...
import { 
  ...
  createTeam, getAllTeams, getMyTeams, requestToJoinTeam, handleTeamJoinRequest, leaveTeam, updateTeam, deleteTeam, getTeamRequests
...
teamrouter.get('/teams/requests', protectRoute, getTeamRequests);
